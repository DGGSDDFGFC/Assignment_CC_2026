...
Music Sequencer
Contributor
NameLuka ParanyakStudent NumberA00041906Class GroupTU850
Video
...
Launch the project in Godot 4
You will start on Line 1. Click any block in the grid to cycle through sounds — G (Guitar), M (Marimba), S (Strings), or back to empty
Use the arrow keys (Up/Down) to switch between the 4 lines
Use the BPM slider to control the playback speed
Press the Play button to start playback — all 4 lines will loop at the same time
Press Stop to pause and go back to editing
...
Class/AssetSourcemain.gdSelf writtenMain.tscnSelf writtenGodot MIDI Player pluginFrom arlez80/GodotMidiPlayer
References

Godot 4 Documentation
Godot MIDI Player plugin by arlez80
